...
class Widget_Webp_To_Png extends TextCraft_Tool_Base {
    ...
    protected function render_tool_content(array $settings): void {
        ...
        <div class="tc-actions">
            <button class="tc-btn tc-btn--accent" id="tc-w2p-convert" type="button">Convert to PNG</button>
            <button class="tc-btn tc-btn--ghost" id="tc-w2p-download" type="button">Download PNG</button>
            <button class="tc-btn tc-btn--ghost tc-btn--clear" id="tc-w2p-clear" type="button">Clear all</button>
        </div>
