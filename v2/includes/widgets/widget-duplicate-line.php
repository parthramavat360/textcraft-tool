...
class Widget_Duplicate_Line extends TextCraft_Tool_Base {
    ...
    protected function render_tool_content(array $settings): void {
        ...
        <div class="tc-actions">
            <button class="tc-btn tc-btn--accent" id="tc-dl-remove" type="button">Remove Duplicates</button>
            <button class="tc-btn tc-btn--ghost" id="tc-dl-copy" type="button">Copy Result</button>
            <button class="tc-btn tc-btn--ghost tc-btn--clear" id="tc-dl-clear" type="button">Clear all</button>
        </div>
