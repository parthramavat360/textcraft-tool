...
class Widget_Text_Diff extends TextCraft_Tool_Base {
    ...
    protected function render_tool_content(array $settings): void { ?>
        ...
        <div class="tc-flex tc-diff-actions">
            <button class="tc-btn tc-btn--primary" id="diff-compare"><i class="fa-solid fa-code-compare"></i> Compare Texts</button>
            <button class="tc-btn tc-btn--ghost tc-btn--clear" id="diff-clear" type="button">Clear all</button>
        ...
        <div class="tctp-result tc-diff-result" id="diff-result">
            ...
            <div class="tctp-rsz-tab-panel tc-diff-panel" id="diff-unified"></div>
            <div class="tctp-rsz-tab-panel tc-diff-panel" id="diff-stats"></div>
        </div>
        </div>
    <?php }
}
