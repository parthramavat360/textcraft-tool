...
class Widget_Pdf_To_Jpg extends TextCraft_Tool_Base {
    ...
    protected function render_tool_content(array $settings): void {
        ...
        <div class="tc-tool-desc">
            Convert each page of a PDF to a JPG image. Choose your preferred DPI for quality. Everything runs in your browser ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â your files are never uploaded.
        </div>
        ...
        <div class="tc-input-group" style="margin-top:16px">
            <?php $this->render_select('tc-p2j-dpi', [
                '72'  => '72 DPI (Screen)',
        ...
        <div class="tc-stats-row">
            <div class="tc-stat-item"><span class="tc-stat-label">Pages</span><span class="tc-stat-value" id="tc-p2j-stat-pages">-</span></div>
            <div class="tc-stat-item"><span class="tc-stat-label">Converted</span><span class="tc-stat-value" id="tc-p2j-stat-done">0</span></div>
            <div class="tc-stat-item tc-stat--saved"><span class="tc-stat-label">Status</span><span class="tc-stat-value" id="tc-p2j-stat-status">Ready</span></div>
        </div>
        <?php
    }
