...
class Widget_Gif_Compressor extends TextCraft_Tool_Base {
    ...
    protected function render_tool_content(array $settings): void {
        ...
        <div class="tc-tool-desc">
            Compress animated and static GIF images. Choose quality level and whether to preserve all frames. Everything runs in your browser ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â your files are never uploaded.
        </div>
