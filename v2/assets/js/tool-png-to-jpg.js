...
(function () {
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener('click', function () {
            ...
            var base = (nameInput && nameInput.value.trim()) ? nameInput.value.trim().replace(/\.jpe?g$/i, '') : (file ? file.name.replace(/\.png$/i, '') : 'image');
            TCTP.downloadBlob(convertedBlob, base + '.jpg');
        });
    }
